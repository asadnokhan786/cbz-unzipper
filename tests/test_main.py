...
def test_main_simple():
    ...
    text_file_1 = os.path.join(dst_path, 'test.txt')
    text_file_2 = os.path.join(dst_path, 'text2.txt')
    text_file_3 = os.path.join(dst_path, 'text3.txt')
    text_file_4 = os.path.join(dst_path, 'subdir/text3.txt')
